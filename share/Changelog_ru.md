...
* Заменен Tesseract OCR на Windows Native OCR (WinRT APIs), устраняя необходимость загрузки или управления внешними языковыми файлами Tesseract.
* Заменен браузер QWebEngine и парсеры на JavaScript на встроенный C++ клиент Google Cloud Translation API.
* Полностью удалены QWebEngine, Leptonica, Tesseract и зависимости песочницы WebEngine, что привело к облегчению и ускорению приложения.
* Ограничена совместимость с OpenSSL 1.1.1w для стабильности сети TLS.
* Удалена автоматическая проверка обновлений при запуске.
